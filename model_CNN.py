...
path1 = 'D:/land class for satellite image/test/runway'    #path of folder of images    
path2 = 'D:/land class for satellite image/test_set/7'  #path of folder to save images    
